...
%we can also study advection and diffusion together




ni = 0.06; %diffusity or viscosity (instead of a2)

L = 10;
N = 400;
T = 5; % the more we wait, the more forward it goes and more it spreads

alpha = 100; % for the new function

 u = 1;
% 
 a1 = -1; % a1*T it says how much and in which direction we should go to take 
